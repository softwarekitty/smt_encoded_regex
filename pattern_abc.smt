...
(declare-fun _slashf_ () Char)
(declare-fun _slashb_ () Char)
...
(define-fun patternAt ((string0 String) (mIndex Int)) Bool
	(ite (and 
			...
			(=  (charOf string0 (+ mIndex 1)) _b_ )
			(=  (charOf string0 (+ mIndex 2)) _c_ ) 
		)
		true
		false
	)
