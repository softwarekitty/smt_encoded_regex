;(azb+c)+cat((xy)+((z+-)+(p+q)+)+)+r
;(set-logic UFNIA) - cannot use this and arrays
...
(declare-fun leaf_0a () Leaf)
(declare-fun leaf_0z () Leaf)
(declare-fun leaf_0bPlus () Leaf)
(declare-fun leaf_0c () Leaf)
(declare-fun leaf_cat () Leaf)
(declare-fun leaf_2x () Leaf)
(declare-fun leaf_2y () Leaf)
(declare-fun leaf_4z () Leaf)
(declare-fun leaf_4dash () Leaf)
(declare-fun leaf_5pPlus () Leaf)
(declare-fun leaf_5q () Leaf)
(declare-fun leaf_r () Leaf)

(declare-const branch_V0_Ar (Array Int Int))
(declare-const branch_V1_Ar (Array Int Int))
(declare-const branch_V2_Ar (Array Int Int))
(declare-const branch_V3_Ar (Array Int Int))
(declare-const branch_V4_Ar (Array Int Int))
(declare-const branch_V5_Ar (Array Int Int))

(declare-const leaf_bPlus_Ar (Array Int Int))
(declare-const leaf_bPlus_Ar (Array Int Int))
							...
							(ite 
								...
								(ite 
									...
									(ite 
										...
										(ite
											(= arrayLength 9)
											(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8))
											(ite 
												(= arrayLength 10)
												(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9))
												(ite 
													(= arrayLength 11)
													(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10))
													(ite 
														(= arrayLength 12)
														(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11))
														(ite 
															(= arrayLength 13)
															(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11)(select inputArray 12))
															(ite 
																(= arrayLength 14)
																(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11)(select inputArray 12)(select inputArray 13))
																(ite 
																	(= arrayLength 15)
																	(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11)(select inputArray 12)(select inputArray 13)(select inputArray 14))
																	(ite 
																		(= arrayLength 16)
																		(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11)(select inputArray 12)(select inputArray 13)(select inputArray 14)(select inputArray 15))
																		(ite 
																			(= arrayLength 17)
																			(+ (select inputArray 0)(select inputArray 1)(select inputArray 2)(select inputArray 3)(select inputArray 4)(select inputArray 5)(select inputArray 6)(select inputArray 7)(select inputArray 8)(select inputArray 9)(select inputArray 10)(select inputArray 11)(select inputArray 12)(select inputArray 13)(select inputArray 14)(select inputArray 15)(select inputArray 16))
																			-2147483648
																		)
																	)
																)
...
;leaf bPlus array contents need to be between 1 and MAX
(assert 
	(forall ((aPlus_index Int))
		(=>
			(and
				(>= aPlus_index 0)
				(< aPlus_index (select branch_V0_Ar 0))
			)
			(and
...
;leaf qPlus array contents need to be between 1 and MAX
(assert 
	(forall ((aPlus_index Int))
		(=>
			(and
				(>= aPlus_index 0)
				(< aPlus_index (arraySum branch_V4_Ar (arraySum branch_V3_Ar (select branch_V1_Ar 0))))
			)
			(and
				(>= (select leaf_aPlus_Ar aPlus_index) 1)
				(<= (select leaf_aPlus_Ar aPlus_index) (length inputString))
...
;branches V0 and V1 are rootVine-level '+' style repetitions, so they must repeat between 1 and MAX times
(assert 
	(and
		(>= (select branch_V0_Ar 0) 1)
		(<= (select branch_V0_Ar 0) (length inputString))
		(>= (select branch_V1_Ar 0) 1)
		(<= (select branch_V1_Ar 0) (length inputString))
	)	
)


;branches V2 and V3 are '+' style repetitions, so all of their vines must repeat between 1 and MAX times
(assert 
	(forall ((V1_index Int))
		(=>
			(and
				(>= V1_index 0)
				(< V1_index (select branch_V1_Ar 0))
			)
			(and
				(>= (select branch_V2_Ar V1_index) 1)
				(<= (select branch_V2_Ar V1_index) (length inputString))
				(>= (select branch_V3_Ar V1_index) 1)
				(<= (select branch_V3_Ar V1_index) (length inputString))
			)
		)	
	)
)

;branches V4 and V5 are '+' style repetitions, so all of their vines must repeat between 1 and MAX times
(assert 
	(forall ((V3_index Int))
		(=>
			(and
				(>= V3_index 0)
				(< V3_index (arraySum branch_V3_Ar (select branch_V1_Ar 0)))
			)
			(and
				(>= (select branch_V4_Ar V3_index) 1)
				(<= (select branch_V4_Ar V3_index) (length inputString))
				(>= (select branch_V5_Ar V3_index) 1)
				(<= (select branch_V5_Ar V3_index) (length inputString))
			)
		)	
	)
)
