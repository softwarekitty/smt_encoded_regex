...
;this V1 should not satisfy (no group of 3-4 non-newlines)
...
;this V1 should not satisfy (less than 3 matching chars)
(assert (= (charOf V1 0) _x_ ))
(assert (= (charOf V1 1) _newline_ ))
(assert (= (length V1) 2))
(check-sat)
...
;this V1 should not satisfy (pattern cannot start at beginning)
(assert (= (charOf V1 0) _newline_ ))
(assert (= (charOf V1 1) _b_ ))
(assert (= (charOf V1 2) _b_ ))
(assert (= (charOf V1 3) _b_ ))
