...
(assert 
	(forall ((V2_index Int))
		(=>
			...
			(and
				(>= (select branch_V2_Ar V2_index) 1)
...
(assert (= (charOf inputString 4) _d_ ))
(assert (= (charOf inputString 5) _e_ ))
...
(get-value ((select branch_V0_Ar 2)))
(get-value ((select branch_V0_Ar 3)))
(get-value ((select branch_V0_Ar 4)))
(get-value ((select branch_V1_Ar 0)))
(get-value ((select branch_V1_Ar 1)))
(get-value ((select branch_V1_Ar 2)))
(get-value ((select branch_V1_Ar 3)))
(get-value ((select branch_V1_Ar 4)))
(get-value ((select branch_V2_Ar 0)))
(get-value ((select branch_V2_Ar 1)))
(get-value ((select branch_V2_Ar 2)))
(get-value ((select branch_V2_Ar 3)))
(get-value ((select branch_V2_Ar 4)))
(get-value ((select leaf_aPlus_Ar 0)))
(get-value ((select leaf_aPlus_Ar 1)))
(get-value ((select leaf_aPlus_Ar 2)))
(get-value ((select leaf_aPlus_Ar 3)))
(get-value ((select leaf_aPlus_Ar 4)))
