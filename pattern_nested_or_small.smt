...
(assert (and (>= ArN 3) (< ArN LENGTH))) ; root capture group is a '+' style repetition
			...
			(=>
				...
				(forall ((i1 Int))
					(=>
						...
						(=>
							(= 1 (s_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))) ;notice we add the i1, a count through s_Ar2 to the a_Ar2, a sum of everything before that count
							(forall ((i2 Int))
								(=>
									(and
										(>= i2 0)
										(< i2 (s_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))))); counting repetitions of (gh+)
									)
									(= _g_
										(charOf 
											inputString
											(+
												...
												(a_Ar0 i0);leaf_p
												(+ i2 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_g
												(a_Ar9 (+ i2 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))))));leaf_hPlus
												(a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0)))));leaf_j
												(a_Ar10 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_kPlus
												(a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))));leaf_w
												(a_Ar1 i0);leaf_q
											)
										)
									)
						...
						(=>
							...
							(forall ((i2 Int))
								(=>
									(and
										(>= i2 0)
										(< i2 (s_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))))
									)
									(forall ((iR Int))
										(=>
											(and
												(>= iR 0)
												(< iR (s_Ar9 (+ i2 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))))))
											)
											(= _h_
												(charOf 
													inputString
													(+
														...
														(a_Ar8 (a_Ar5 (a_Ar0 i0)));leaf_nPlus
														(a_Ar0 i0);leaf_p
														(+ i2 1 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_g
														(a_Ar9 (+ i2 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))))));leaf_hPlus
														(a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0)))));leaf_j
														(a_Ar10 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_kPlus
														(a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))));leaf_w
						...
						(=>
							...
							(forall ((i2 Int))
								(=>
									(and
										(>= i2 0)
										(< i2 (s_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0)))))); counting repetitions of (jk+)
									)
									(= _j_
										(charOf 
											inputString
											(+
												...
												(a_Ar8 (a_Ar5 (a_Ar0 i0)));leaf_nPlus
												(a_Ar0 i0);leaf_p
												(a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))));leaf_g
												(a_Ar9 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_hPlus
												(+ i2 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_j
												(a_Ar10 (+ i2 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0)))))));leaf_kPlus
												(a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))));leaf_w
												(a_Ar1 i0);leaf_q
											)
										)
						...
						(=>
							...
							(forall ((i2 Int))
								(=>
									(and
										(>= i2 0)
										(< i2 (s_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))))
									)
									(forall ((iR Int))
										(=>
											(and
												(>= iR 0)
												(< iR (s_Ar10 (+ i2 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))))))
											)
											(= _k_
												(charOf 
													inputString
													(+
														...
														(a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))));leaf_g
														(a_Ar9 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_hPlus
														(+ i2 1 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_j
														(a_Ar10 (+ i2 (a_Ar7 (a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0)))))));leaf_kPlus
														(a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))));leaf_w
														(a_Ar1 i0);leaf_q
														iR
							...
							(= _w_
								(charOf 
									...
									(+
										...
										(a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0)))));leaf_g
										(a_Ar9 (a_Ar6 (a_Ar3 (+ i1 (a_Ar2 (a_Ar1 i0))))));leaf_hPlus
										(a_Ar7 (a_Ar4 (+ i1 1 (a_Ar2 (a_Ar1 i0)))));leaf_j
										(a_Ar10 (a_Ar7 (a_Ar4 (+ i1 1 (a_Ar2 (a_Ar1 i0))))));leaf_kPlus
										(a_Ar4 (+ i1 (a_Ar2 (a_Ar1 i0))));leaf_w
										(a_Ar1 i0);leaf_q
									)
								)
...
(assert (= (charOf inputString 2) _p_ ))
(assert (= (charOf inputString 3) _j_ ))
(assert (= (charOf inputString 4) _k_ ))
(assert (= (charOf inputString 5) _w_ ))
(assert (= (charOf inputString 6) _q_ ))
(assert (= (charOf inputString 7) _m_ ))
(assert (= (charOf inputString 8) _n_ ))
(assert (= (charOf inputString 9) _n_ ))
(assert (= (charOf inputString 10) _n_ ))
(assert (= (charOf inputString 11) _n_ ))
(assert (= (charOf inputString 12) _p_ ))
(assert (= (length inputString) 13))

(check-sat)
;(check-sat-using (par-or(! smt :random-seed 709)(! smt :random-seed 311)(! smt :random-seed 1069)(! smt :random-seed 41303)(! smt :random-seed 51)))
