;pattern: ab{0, }bc  (notice that the space after ',' is important)
(set-logic UFNIA)
(declare-sort Char 0)
...
(define-fun patternAt ((string0 String) (mIndex Int)) Bool
	...
	(and 
		...
		(= (charOf string0 (+ mIndex prefixLength runLength)) _b_)
		(= (charOf string0 (+ mIndex prefixLength runLength 1)) _c_)
	)
)
