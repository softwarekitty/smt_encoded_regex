;a simple regex: ab+c
(declare-const LENGTH Int)(assert (= LENGTH 5))
...
;///////////////////Constrain Repetitions//////////////////

(declare-const bReps Int)
(assert (and (>= bReps 1)(<= bReps LENGTH)))

;///////////////////Define Leafy Variables//////////////////

(declare-fun inputString () String)
(declare-const patternBegin Int)
(assert (and (>= patternBegin 0)(< patternBegin LENGTH)))

(declare-sort Leaf 0)

(declare-fun leaf_a () Leaf)
(declare-fun leaf_bPlus () Leaf)
...
;///////////////leaf_a/////////////////
(define-fun leaf_a_Sat () Bool (= _a_ (charOf inputString patternBegin)))

;///////////////leaf_bPlus/////////////////
(define-fun leaf_bPlus_Sat () Bool
	(forall ((iR Int))
		(=>
			(and
				(>= iR 0)
			...
			(= _b_ (charOf inputString (+ patternBegin iR 1)))
		)
	)
)
...
;///////////////leaf_c/////////////////
(define-fun leaf_c_Sat () Bool (= _c_ (charOf inputString (+ patternBegin 1 bReps))))
...
(assert (= (charOf inputString 3) _b_ ))
